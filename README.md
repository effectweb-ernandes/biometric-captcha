...
> Detecção de bots por biometria comportamental passiva — sem imagens, sem puzzles, sem frição para o usuário.
...
A resposta está na imperfeicão humana.

---

## A Solução: Biometria Comportamental

Humanos são cronometricamente imperfeitos — e essa imperfeicão é sua assinatura única.
...
*A imperfeicão humana é a melhor senha.*
