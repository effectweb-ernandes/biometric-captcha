...
Desenvolvido como alternativa comportamental ao reCAPTCHA classico.
A imperfeicao humana e a melhor senha.├── README.md                          ✅
├── backend/
│   └── server.js                      ✅  API Node.js + JWT
├── database/
│   └── schema.sql                     ✅  Schema PostgreSQL
└── frontend/
    ├── biometric-collector.js         ✅  Script do coletor
    └── index.html                     ✅  Exemplo de integração
